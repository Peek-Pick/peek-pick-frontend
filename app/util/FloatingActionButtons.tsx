...
export function BackButton() {
    ...
    return (
        <button
            onClick={() => navigate(-1)}
            className="fixed bottom-6 right-4 bg-white hover:bg-gray-100 text-gray-600 rounded-full p-3 shadow-md ring-1 ring-gray-300 transition-all duration-200 z-50"
            aria-label="뒤로가기"
        >
            <ArrowLeft size={20} />
        </button>
